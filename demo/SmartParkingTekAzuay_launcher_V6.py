...
class MainWindow(QWidget):
    def __init__(self):
        ...
        self.background_image = QPixmap('static/img/fondo.jpg.jpg') 
        ...
        social_label = QLabel('<a href="http://localhost/demo/templates/index.html." style="color: lightblue;">Visualizar Interfaz Web</a>')
    ...
    def run_demo_test(self):
        subprocess.run(['python', 'demo_test_V10_2.py'])

    def run_coordinate_generator(self):
        subprocess.run(['python', 'Car_Parking_Coordinate_Generator_V35.py'])
